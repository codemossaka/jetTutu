            ...
            TopAppBar(title = {}, navigationIcon = {
                ...
                Button(onClick = {
                    Toast.makeText(context,
                        "Vous avez clique sur le button Войти",
                ...
                IconButton(onClick = {
                    Toast.makeText(context, "Vous avez clique sur l'icon Menmu", Toast.LENGTH_SHORT)
                        .show()
                }) {
            ...
            Column(modifier = Modifier.padding(horizontal = 10.dp)) {
                ...
                Card(elevation = 2.dp) {
                    Row(horizontalArrangement = Arrangement.Center,
                        ...
                        Image(painter = painterResource(id = R.drawable.master),
                            contentDescription = "master",
                            modifier = Modifier.padding(end = 7.dp))
                        Image(painter = painterResource(id = R.drawable.mir),
                ...
                Row(modifier = Modifier.fillMaxWidth(),
                    ...
                    Image(painter = painterResource(id = R.drawable.apple),
                        contentDescription = "apple", modifier = Modifier.aspectRatio(10f/10f))
                    Spacer(modifier = Modifier.width(10.dp))
